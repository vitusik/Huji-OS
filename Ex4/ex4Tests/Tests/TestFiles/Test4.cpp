...
#define CACHE_LOG_PATH "CacheLog4"
#define STAT_LOG_PATH "StatLog4"
#define BUFFER_OUTPUT "BufferOutput4"
...
int main(int argc, char *argv[])
{
    try
    {
        ...
        if (!CacheFS_init(10, FBR, 0.5, 2))
        {
            std::cerr << "You should check the partitions" << std::endl;
            return -1;
        }
        if (CacheFS_init(2, FBR, 0.5, 0.5))
        {
