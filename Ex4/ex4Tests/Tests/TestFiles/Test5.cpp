...
#define CACHE_LOG_PATH "CacheLog5"
#define STAT_LOG_PATH "StatLog5"
#define BUFFER_OUTPUT "BufferOutput5"
...
int main(int argc, char *argv[])
{
    try
    {
        ...
        if (!CacheFS_init(10, FBR, 0.5, 5))
        {
            std::cerr << "You should check the partitions" << std::endl;
            return -1;
        }
        if (CacheFS_init(6, FBR, 0.4, 0.3333))
        {
